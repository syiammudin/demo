    ...
    @if($type == 'lanscape')
        <script type="text/php">
            if (isset($pdf)) {
                ...
                $pdf->page_text(20, $y, "Form No. :  GMF/Q-232 R3" , $font, $size );
            }
        </script>
        ...
        <table class="table table-bordered " style="margin-top: -2px; margin-bottom:0px;">
            <tr>
                ...
                <td style="border-right: 1px solid white ;">
                    ...
                    <table class="fullwidth">
                        <tr>
                            <td style="width:120px;" valign="top"><input type="checkbox" @if(!empty($request->ComponentRequest->aircraft_type) ) checked @endif >
                            AIRCRAFT TYPE</td>
                            <td style="width:5px;" valign="top">: </td>
                            <td>{{ str_replace('|',';',$request->ComponentRequest->aircraft_type) }}</td>
                        </tr>
                        <tr>
                            <td style="width:120px;"><input type="checkbox" @if(!empty($som['ENGINE'])) @endif >
                            ENGINE</td>
                            <td style="width:5px;">: </td>
                            <td>@if(!empty($som['ENGINE']) ) {{ strtoupper($som['ENGINE']) }} @endif</td>
                        </tr>
                        <tr>
                            <td style="width:120px;"><input type="checkbox" @if(!empty($som['APU'])) @endif >
                            APU</td>
                            <td style="width:5px;">: </td>
                            <td>@if(!empty($som['APU']) ) {{ strtoupper($som['APU']) }}  @endif</td>
                        </tr>
                        <tr>
                            <td style="width:120px;"> <br><br> </td>
                            <td style="width:5px;"> </td>
                            <td></td>
                        </tr>
                        <tr>
                        ...
                        @foreach( $request->ComponentDocument as $doc )
                          @if($doc->document_type == 'Maintenance Manual')
                            ...
                            <tr>
                              ...
                              <td style="width:5px;"></td>
                              <td>Rev {{ strtoupper($doc->rev) }} , Rev Date {{  date('d-M-y', strtotime($doc->rev_date)) }}</td>
                            </tr>
        ...
        <table class="table table-bordered mini-line-height" style="margin-top: -2px; margin-bottom:0px;">
             ...
             <?php
              ...
              @if($loop == 0)
                <tr>
                  <td style="border-bottom : 1px solid white ;">N/A</td>
                  <td style="border-bottom : 1px solid white ;">N/A</td>
                  <td style="border-bottom : 1px solid white ;">N/A</td>
                  <td style="border-bottom : 1px solid white ;">N/A</td>
                  <td style="border-bottom : 1px solid white ;">N/A</td>
              ...
              @for($i = 0; $i < $loop; $i++)
                  <tr>
                      <td class="text-center" style="border-bottom : 1px solid white ;">@if($no_material <= $tot_material) {{ $no_material++ }} @endif</td>
                      <td class="text-center" style="border-bottom : 1px solid white ;">@if(!empty($request->ComponentMaterialPlanning[$i]->part_number)) {{ $request->ComponentMaterialPlanning[$i]->part_number }} @endif </td>
                      <td class="text-center" style="border-bottom : 1px solid white ;">@if(!empty($request->ComponentMaterialPlanning[$i]->part_description)) {{ $request->ComponentMaterialPlanning[$i]->part_description }} @endif </td>
                      <td class="text-center" style="border-bottom : 1px solid white ;">@if(!empty($request->ComponentMaterialPlanning[$i]->qty)) {{ $request->ComponentMaterialPlanning[$i]->qty }} @endif </td>
                      <td class="text-center" style="border-bottom : 1px solid white ;">@if($no_manhours <= $tot_manhours) {{ $no_manhours++ }} @endif</td>
                      <td class="text-center" style="border-bottom : 1px solid white ;">@if(!empty($request->ComponentManhoursPlanning[$i]->task_name)) {{ $request->ComponentManhoursPlanning[$i]->task_name }} @endif </td>
                      <td class="text-center" style="border-bottom : 1px solid white ;">@if(!empty($request->ComponentManhoursPlanning[$i]->man_hour)) {{ $request->ComponentManhoursPlanning[$i]->man_hour }} @endif </td>
                      <td class="text-center" style="border-bottom : 1px solid white ;">@if(!empty($request->ComponentManhoursPlanning[$i]->man_power)) {{ $request->ComponentManhoursPlanning[$i]->man_power }} @endif </td>
                  </tr>
              @endfor
             <tr>
                 <td
