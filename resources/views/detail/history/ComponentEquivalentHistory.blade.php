                    ...
                    <tr>
                        ...
                        <tr>
                            <td colspan="4">
                                ...
                                <input type="checkbox" @if($ComponentRequest->effect_maintenance_procedure == 0) checked @endif > NO <br>
                                <input type="checkbox" @if($ComponentRequest->effect_maintenance_procedure == 1) checked @endif > YES
                            </td>
                        </tr>
                        <tr>
                            <td colspan="4">
                        ...
                        <tr>
                            <td colspan="2">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9">
                                        @if(!empty($recomended_tool->name)) {{ $recomended_tool->name }} @endif
                                    </div>
                                </div>
                            </td>
                            <td colspan="2">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9">
                                        @if(!empty($alternate_tool->name)) {{ $alternate_tool->name }} @endif
                                    </div>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9">
                                        @if(!empty($recomended_tool->model)) {{ $recomended_tool->model }} @endif
                                    </div>
                                </div>
                            </td>
                            <td colspan="2">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9">
                                        @if(!empty($alternate_tool->model)) {{ $alternate_tool->model }} @endif
                                    </div>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="2">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9">
                                        @if(!empty($recomended_tool->manufacture)) {{ $recomended_tool->manufacture }}  @endif
                                    </div>
                                </div>
                            </td>
                            <td colspan="2">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9">
                                        @if(!empty($alternate_tool->manufacture)) {{ $alternate_tool->manufacture }} @endif
                                    </div>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2" class="text-center">
                                ...
                                <img src="uploads/users/signature/{{ $user->signature  }}" height="100" style="margin-bottom : -20px; margin-top: -30px;">
                                @endif <br>
                                {{ $user->name }} / {{ $user->id_number }}<br>
                                {{ $user->position_name }}
                            </td>
                            <td colspan="2" class="text-center">
                                Approved by : <br>
        ...
        <tr>
            <td colspan="11">
                <div class="row">
                    ...
                    <div class="col-xs-5">
                        : @if(!empty($maintenance_task->ad )) {{ $maintenance_task->value_ad }} @endif
                    </div>
                </div>
            </td>
        </tr>
        <tr>
            <td colspan="11">
                <div class="row">
                    ...
                    <div class="col-xs-5">
                        : @if(!empty($maintenance_task->cmm )) {{ $maintenance_task->value_cmm }} @endif
                    </div>
                </div>
            </td>
        </tr>
        <tr>
            <td colspan="11">
                <div class="row">
                    ...
                    <div class="col-xs-5">
                        : @if(!empty($maintenance_task->amm )) {{ $maintenance_task->value_amm }} @endif
                    </div>
                </div>
            </td>
        </tr>
        <tr>
            <td colspan="11">
                <div class="row">
                    ...
                    <div class="col-xs-5">
                        : @if(!empty($maintenance_task->sb )) {{ $maintenance_task->sb }} @endif
                    </div>
                </div>
            </td>
        </tr>
        <tr>
            <td colspan="11">
                <div class="row">
                    ...
                    <div class="col-xs-5">
                        : @if(!empty($maintenance_task->others )) {{ $maintenance_task->others }} @endif
                    </div>
                </div>
            </td>
        </tr>
        ...
        <tr>
            <td colspan="6">
                <div class="row">
                    ...
                    <div class="col-xs-5">
                        : @if(!empty($recomended->wiring_diagram )) {{ $recomended->wiring_diagram }} @endif
                    </div>
                </div>
            </td>
            <td colspan="5">
                <div class="row">
                    ...
                    <div class="col-xs-5">
                        : @if(!empty($alternate->wiring_diagram )) {{ $alternate->wiring_diagram }} @endif
                    </div>
                </div>
            </td>
        </tr>
        <tr>
            <td colspan="6">
                <div class="row">
                    ...
                    <div class="col-xs-5">
                        : @if(!empty($recomended->tm )) {{ $recomended->tm }} @endif
                    </div>
                </div>
            </td>
            <td colspan="5">
                <div class="row">
                    ...
                    <div class="col-xs-5">
                        : @if(!empty($alternate->tm )) {{ $alternate->tm }} @endif
                    </div>
                </div>
            </td>
        </tr>
        <tr>
            <td colspan="6">
                <div class="row">
                    ...
                    <div class="col-xs-5">
                        : @if(!empty($recomended->ts )) {{ $recomended->ts }} @endif
                    </div>
                </div>
            </td>
            <td colspan="5">
                <div class="row">
                    ...
                    <div class="col-xs-5">
                        : @if(!empty($alternate->ts )) {{ $alternate->ts }} @endif
                    </div>
                </div>
            </td>
        </tr>
        <tr>
            <td colspan="6">
                <div class="row">
                    ...
                    <div class="col-xs-5">
                        : @if(!empty($recomended->amm )) {{ $recomended->amm }} @endif
                    </div>
                </div>
            </td>
            <td colspan="5">
                <div class="row">
                    ...
                    <div class="col-xs-5">
                        : @if(!empty($alternate->amm )) {{ $alternate->amm }} @endif
                    </div>
                </div>
            </td>
        </tr>
        <tr>
            <td colspan="6">
                <div class="row">
                    ...
                    <div class="col-xs-5">
                        : @if(!empty($recomended->others )) {{ $recomended->others }} @endif
                    </div>
                </div>
            </td>
            <td colspan="5">
                <div class="row">
                    ...
                    <div class="col-xs-5">
                        : @if(!empty($alternate->others )) {{ $alternate->others }} @endif
                    </div>
                </div>
            </td>
        </tr>
