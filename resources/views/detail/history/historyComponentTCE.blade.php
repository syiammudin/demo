             ...
             <?php
              ...
              @for($i = 0; $i < $loop; $i++)
                  <tr>
                      ...
                      <td style="border-bottom : 1px solid white ;">@if(!empty($request->ComponentMaterialPlanning[$i]->desciption)) {{ $request->ComponentMaterialPlanning[$i]->desciption }} @endif </td>
                      ...
                      <td style="border-bottom : 1px solid white ;">@if(!empty($request->ComponentManhoursPlanning[$i]->desciption)) {{ $request->ComponentManhoursPlanning[$i]->desciption }} @endif </td>
                                 ...
                                 <table style="width:100%">
                                     <tr>
                                         ...
                                         <td class="text-center" style="width:33.3%">
                                             ...
                                             @endif
                                             <br>
                                             NAME : @if($request['approve_name'] != null) {{ \App\User::find($request['approve_name'])->name  }} @endif <br>
                                             DATE : @if($request['approve_name'] != null) {{  date('d F Y', strtotime(\App\RequestHistory::where('request_submittion_id', $request['id'])->where('status', 2)->orderBy('id', 'desc')->first()->created_at)) }} @endif
                                         </td>
                                     </tr>
                                 </table>
                             </td>
