...
<html lang="en" dir="ltr">
    ...
    <body style="margin-top:150 px; color : #463939 ;">
        ...
        <div id="header">
            ...
            <span style="float:left">Date : {{ date('F, d Y', strtotime($rev->created_at)) }}</span> CAAC Certificate No: F06200762<span style="float:right">Revision : {{ $rev->revision }}</span> <br>
