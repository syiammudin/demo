        ...
        <div class="col-lg-12  z-index-41">
            <div class="panel panel-default  ">
                <div class="panel-heading no-border clearfix">
                    <h1 class="page-title">Request Component</h1>
                </div>
                <div class="panel-body">
                      ...
                      <el-popover
                          ...
                          trigger="hover">
                            ...
                            <el-form-item label="Unit Type">
                              <el-input size="small" placeholder="Unit Type" v-model="input.component_type"></el-input>
                            </el-form-item>
                  ...
                  <el-table @sort-change="sortChange" :default-sort="{prop: sort, order: order}" :data="tableData.data" style="width: 100%"
                          ...
                          v-loading="loading">
                        <el-table-column sortable width="150" prop="request_number" label="No Request"></el-table-column>
                        <el-table-column sortable width="150" prop="request_type" label="Request Type"></el-table-column>
                        <el-table-column sortable width="200" prop="part_number" label="Part Number"></el-table-column>
                        <el-table-column sortable width="160" prop="component_type" label="Component Type"></el-table-column>
                        <el-table-column sortable width="200" prop="aircraft_type" label="Aircraft Type"></el-table-column>
                        <el-table-column sortable width="140" prop="ata_chapter" label="ATA Chapter"></el-table-column>
                        <el-table-column sortable width="150" prop="created_at" label="Date"></el-table-column>
                                ...
                                <el-dropdown>
                                    ...
                                    <el-dropdown-menu slot="dropdown">
                                      ...
                                      <!-- <div v-if="scope.row.status_read != null">
                                          <a @click="aprove(scope.row)"><el-dropdown-item v-if="((scope.row.status == 3 && scope.row.qsa_part_approve == auth_id) || (scope.row.status == 6 && scope.row.qsa_part_approve == auth_id) || scope.row.status == 4) && scope.row.status_read.split('|').find(r => r == auth_id)"><i class="fa fa-check"></i> Aprove</el-dropdown-item></a>
                                          <a @click="reject(scope.row)"><el-dropdown-item v-if="((scope.row.status == 3 && scope.row.qsa_part_approve == auth_id) || (scope.row.status == 6 && scope.row.qsa_part_approve == auth_id) || scope.row.status == 4) && scope.row.status_read.split('|').find(r => r == auth_id)"><i class="fa fa-times"></i> Reject</el-dropdown-item></a>
...
export default {
    ...
    data() {
        return {
          ...
          page: 1,
          pageSize: 10,
          data: [] , url : BASE_URL + 'submit_component' , dialogVisible: false , auth_id : AUTH_LOGIN_ID ,
          datamain : [] , mainform : true, auth_personel : false , documents : false, materials : false, tools : false,
          formReject : false, input : {}, search : '', role_request : ROLE_REQUEST, ScoreDialog : false, id_request : '', resubmitDialog : false, id : '',
