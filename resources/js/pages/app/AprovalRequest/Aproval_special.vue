        ...
        <div class="col-lg-12  z-index-41">
            <div class="panel panel-default">
                <div class="panel-heading no-border clearfix">
                    <h1 class="page-title">Request Special</h1>
                </div>
                <div class="panel-body">
                  ...
                  <el-table @sort-change="sortChange" :default-sort="{prop: sort, order: order}" :data="tableData.data" style="width: 100%"
                        ...
                        <el-table-column prop="part_number" label="NDT Method"></el-table-column>
                          ...
                          <template slot-scope="scope">
                              <el-dropdown>
                                  ...
                                  <el-dropdown-menu slot="dropdown">
                                    ...
                                    <a v-if="scope.row.step_request_type == 're-Submit'" @click="resubmitDialog = true, id = scope.row.id" ><el-dropdown-item> <i class="fa fa-file-o"></i>Note Resubmit</el-dropdown-item></a>
...
export default {
    ...
    computed : {
      ...
      filteredList() {
          return this.data.map(d => {
                  ...
                  .filter(data => !this.search || data.request_number.toLowerCase().includes(this.search.toLowerCase()) ||
    ...
    data() {
        return {
          ...
          page: 1,
          pageSize: 10,
          data: [] , url : BASE_URL + 'submit_special' , dialogVisible: false , auth_id : AUTH_LOGIN_ID ,
          datamain : [] , mainform : true, auth_personel : false , documents : false, materials : false, tools : false,
          formReject : false, input : {}, search : '', role_request : ROLE_REQUEST, ScoreDialog : false, resubmitDialog : false, id : '',
