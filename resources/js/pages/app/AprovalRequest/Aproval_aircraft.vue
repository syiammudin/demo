        ...
        <div class="col-lg-12  z-index-41">
            <div class="panel panel-default  ">
                <div class="panel-heading no-border clearfix">
                    <h1 class="page-title">Request Aircraft</h1>
                </div>
                <div class="panel-body">
                  ...
                  <el-table @sort-change="sortChange" :default-sort="{prop: sort, order: order}" :data="tableData.data" style="width: 100%"
                          ...
                          v-loading="loading">
                        <el-table-column prop="request_number" label="No Request" sortable width="150px"></el-table-column>
                        <!-- <el-table-column prop="aircraft_request.number" label="Number" sortable></el-table-column> -->
                        <el-table-column prop="request_type" label="Request Type" width="120px"></el-table-column>
                        ...
                        <el-table-column prop="maintenance_area_value" label="Maentenance Area" width="150px"></el-table-column>
                        <el-table-column prop="aircraft_type" label="Aircraft Type" width="120px"></el-table-column>
                        <el-table-column prop="user.name" label="Name of User" width="150px"></el-table-column>
                        <el-table-column prop="aircraft_request.aircraft_manufacturer"  label="Manufacture" width="150px"></el-table-column>
    ...
    <el-dialog title="Form Reject " :visible.sync="formReject" >
        <form class="form-horizontal">
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input type="text" class="form-control" readonly v-model="input.number">
                </div>
            </div>
            <div class="form-group">
...
export default {
      ...
      filteredList() {
          return this.data.map(d => {
                  ...
                  .filter(data => !this.search ||
                          ...
                          data.aircraft_request.customer.toLowerCase().includes(this.search.toLowerCase()) ||
                          data.aircraft_request.maintenance_area_value.toLowerCase().includes(this.search.toLowerCase()) ||
                          ...
                          data.aircraft_request.authority.toLowerCase().includes(this.search.toLowerCase())
                      )
      }
    },
    mounted(){
    ...
    data() {
        return {
          ...
          page: 1,
          pageSize: 10,
          data: [] , url : BASE_URL + 'submit_aircraft' , dialogVisible: false , auth_id : AUTH_LOGIN_ID , search : '',
    ...
    methods: {
      ...
      reject(data){
          ...
          this.input = data.aircraft_request
