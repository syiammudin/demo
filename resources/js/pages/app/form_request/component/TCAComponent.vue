<template >
    <div class="">
        ...
        <div class="form-horizontal" v-show="mainform">
            ...
            <div class="form-group">
                <label class="col-sm-3 control-label">No Document Component</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" v-model="input.document_component_number" placeholder="No Document Component">
                    <span v-if="err.document_component_number" class="text-danger"> {{ err.document_component_number[0] }}</span>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" v-model="input.ata_chapter" placeholder="Ata Chapter">
        ...
        <div  class="form-horizontal"  v-show="shopability">
            ...
            <div class="form-group">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" v-model="summary_of_maintenance['OWNER CODE']" placeholder="Nomenclature">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" v-model="summary_of_maintenance['PART NUMBER']" placeholder="Part Number">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" v-model="summary_of_maintenance['MANUFACTURER']" placeholder="Manufacturer">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-4 control-label">Aircraft Type</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" v-model="summary_of_maintenance['AIRCRAFT TYPE']" placeholder="Aircraft Type">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-4 control-label">ATA Chapter</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" v-model="summary_of_maintenance['ATA CHAPTER']" placeholder="ATA Chapter">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        <label class="col-sm-4 control-label">Document Required</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" v-model="summary_of_maintenance['Document Required']" placeholder="Document Required">
                            <br>
                            <div class="row">
                                <div class="col-lg-6">
                                    <input type="text"  v-model="summary_of_maintenance['Rev Doc']" class="form-control" placeholder="Rev, #">
                                </div>
                                <div class="col-lg-6">
                                    <el-date-picker
                                    v-model="summary_of_maintenance['Rev Date Doc']"
                                    type="date"
                    ...
                    <table class="table table-striped" v-if="list_test_equipment.length != 0">
                        <tbody>
                            <tr v-for="d, i in list_test_equipment">
                                ...
                                <td> <el-input type="text" v-model="d.available" placeholder="Avail"></el-input> </td>
                                <td> <el-input type="text" v-model="d.alternate_pn" placeholder="Alternate PN"></el-input> </td>
                                <td> <el-input type="text" v-model="d.alternate_name" placeholder="Alternate Name"></el-input> </td>
                    ...
                    <table class="table table-striped" v-if="list_special_tools.length != 0">
                        <tbody>
                            <tr v-for="d, i in list_special_tools">
                                <td> <el-input type="text" v-model="d.part_number" placeholder="Part Number"></el-input> </td>
                                <td> <el-input type="text" v-model="d.part_name" placeholder="Part Name"></el-input> </td>
                                <td> <el-input type="text" v-model="d.available" placeholder="Avai"></el-input> </td>
                                <td> <el-input type="text" v-model="d.alternate_pn" placeholder="Alternate PN"></el-input> </td>
                                <td> <el-input type="text" v-model="d.alternate_name" placeholder="Alternate Name"></el-input> </td>
                                <td> <el-input type="text" v-model="d.remarks" placeholder="Remark"></el-input> </td>
            ...
            <div class="line-dashed"></div>
            <div class="form-group">
                <label class="col-lg-2 control-label">Available Qualified Personel <el-button @click="addPersonel()" size="mini" circle icon="fa fa-plus" ></el-button> </label>
                <div class="col-lg-10">
                    <table class="table table-striped">
                        <tbody>
                            <tr v-for="d, i in list_personel">
                                ...
                                <td> <el-input type="text" v-model="d.id_number"  placeholder="ID of Nominate"></el-input></td>
...
export default {
    ...
    data() {
        return {
            data : [] , input : {} , err : [],
            url : BASE_URL + 'submit_component', base_url : BASE_URL,
                mainform : true , equivalent : false, shopability : false , equivalent : false, personelDialog : false , tool_category : {} ,
            mainform : true , equivalent : false, shopability : false ,
            ...
            recomended_tool : {} , alternate_tool : {}, list_personel : [], test_condition : {}, storage_condition : {},
