...
<div class="" >
    <div class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-9">
                <el-select  v-model="input.nominate"  clearable placeholder="Select Request type" >
                    <el-option label="Nominated NDT Personnel" value="Nominated NDT Personnel"> </el-option>
        ...
        <div class="form-group">
          <label class="label-control col-lg-3">Level </label>
          <div class="col-lg-9">
            <input type="text" class="form-control" v-model='input.level' placeholder="Level">
            <span v-if="err.level" > {{ err.level[0] }}</span>
          </div>
        </div>
        <div class="form-group" v-if="input.nominate == 'Nominated NDT Personnel'">
            <label class="label-control col-lg-3" >Certificate</label>
        ...
        <div class="form-group" v-if="input.nominate == 'Nominated NDT Personnel'">
            <label class="label-control col-lg-3">NDT Personnel Authorization (*)</label>
            <div class="col-lg-9 row">
                <div class="col-lg-12">
...
export default {
    ...
    data(){
        return {
            input : {}, personelDialog : false, url : BASE_URL +'submit_special',  attach : {} ,fileList : [],
            personelList: [], err : [],
            dataPersonel : []
        }
    },
    ...
    methods : {
        ...
        save(){
          ...
          if(this.input.staff_authorization == null && this.input.nominate == 'Nominated NDT Personnel'){
          ...
          if((this.input.certificate_competence != null  && this.input.nominate == 'Nominated Technician')
            ...
            (this.input.staff_authorization != null && this.input.certificate_competence != null &&
              this.input.nominate == 'Nominated NDT Personnel')){
