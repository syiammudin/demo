...
<div>
        ...
        <div class="col-lg-12  z-index-41">
            <div class="panel panel-default  ">
                <div class="panel-heading no-border clearfix">
                    <h1 class="page-title">Customer Aircraft</h1>
                </div>
                <div class="panel-body">
                    ...
                    <el-table :data="this.filteredList.slice((page-1)*10, 10*page)" style="width: 100%" >
                        <el-table-column prop="name_customer" label="Customer Name" ></el-table-column>
    ...
    <el-dialog title="Form Customer " :visible.sync="showForm" >
        <form class="form-horizontal">
            <div class="form-group">
                <label class="col-md-3">Name Customer</label>
                <div class="col-md-9">
                    <input type="text" class="form-control" v-model="input.name_customer">
                </div>
            </div>
    ...
    <el-dialog title="Form Aircraft " :visible.sync="formImport" >
        ...
        For format import excel, you can  <a :href="base_url+'document_n_import/master/sample_aircraft_type.xlsx'" target="_blank" style="color:blue!important">download here</a>
    </el-dialog>
</div>
</template>
...
export default {
    ...
    data(){
        return {
            data : [], input : {} , showForm : false, url : BASE_URL + 'MasterCustomerAircraft', search: '', page: 1, formImport : false ,
