        ...
        <div class="col-lg-12  z-index-41">
            <div class="panel panel-default  ">
                <div class="panel-heading no-border clearfix">
                    <h1 class="page-title">Unit of Measure</h1>
                </div>
                <div class="panel-body">
                    ...
                    <el-table :data="this.filteredList.slice((page-1)*10, 10*page)" style="width: 100%" >
                        <el-table-column prop="unit" label="Unitr" ></el-table-column>
    ...
    <el-dialog title="Form Aircraft " :visible.sync="showForm" >
        <form class="form-horizontal">
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input type="text" class="form-control" v-model="input.unit">
                </div>
            </div>
...
export default {
    ...
    data(){
        return {
            data : [], input : {} , showForm : false, url : BASE_URL + 'UnitOfMeasure', search: '', page: 1
        }
    },
    mounted(){
        this.getData()
