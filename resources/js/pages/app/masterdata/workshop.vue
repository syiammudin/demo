    ...
    <el-dialog title="Form Base Maintenance " :visible.sync="showForm" >
        <form class="form-horizontal">
            <div class="form-group">
                <label class="col-md-3">Workshop</label>
                <div class="col-md-9">
                    <input type="text" class="form-control" v-model="input.workshop">
                </div>
            </div>
...
export default {
    ...
    data(){
        return {
            data : [], input : {} , showForm : false, url : BASE_URL + 'controller_workshop', search: '', page: 1, formImport : false ,
            inputfile : {}
        }
    },
    mounted(){
