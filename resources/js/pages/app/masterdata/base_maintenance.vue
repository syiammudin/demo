...
<div>
        ...
        <div class="col-lg-12  z-index-41">
            <div class="panel panel-default  ">
                <div class="panel-heading no-border clearfix">
                    <h1 class="page-title">Base Maintenance</h1>
                </div>
                <div class="panel-body">
                    ...
                    <el-table :data="this.filteredList.slice((page-1)*10, 10*page)" style="width: 100%" >
                        <el-table-column prop="hangar_name" label="Hangar Name" ></el-table-column>
    ...
    <el-dialog title="Form Base Maintenance " :visible.sync="showForm" >
        <form class="form-horizontal">
            <div class="form-group">
                <label class="col-md-3">Name</label>
                <div class="col-md-9">
                    <input type="text" class="form-control" v-model="input.hangar_name">
                </div>
            </div>
...
export default {
    computed: {
        filteredList() {
            return this.data.filter(data => !this.search || data.hangar_name.toLowerCase().includes(this.search.toLowerCase()) )
        }
    },
    data(){
        return {
            data : [], input : {} , showForm : false, url : BASE_URL + 'base_maintenance', search: '', page: 1, formImport : false ,
            inputfile : {}
        }
    },
    mounted(){
