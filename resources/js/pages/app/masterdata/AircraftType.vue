...
<div>
        ...
        <div class="col-lg-12  z-index-41">
            <div class="panel panel-default  ">
                <div class="panel-heading no-border clearfix">
                    <h1 class="page-title">Aircraft Type</h1>
                </div>
    ...
    <el-dialog title="Form Aircraft " :visible.sync="showForm" >
        <form class="form-horizontal">
            <div class="form-group">
                <label class="col-md-3">Aircraft Type</label>
                <div class="col-md-9">
                    <input type="text" class="form-control" v-model="input.aircraft_type">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <textarea  class="form-control" v-model="input.manufacturer"></textarea>
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-3">Engine (Use Sparator ',' for add another type)</label>
                <div class="col-md-9">
                    <input type="text" class="form-control" v-model="input.engine">
                </div>
            </div>
    ...
    <el-dialog title="Form Aircraft " :visible.sync="formImport" >
        ...
        For format import excel, you can  <a :href="base_url+'document_n_import/master/sample_aircraft_type.xlsx'" style="color:blue!important" target="_blank">download here</a>
    </el-dialog>
</div>
</template>
...
export default {
    ...
    data(){
        return {
            data : [], input : {} , showForm : false, url : BASE_URL + 'AircraftType', search: '', page: 1, formImport : false ,
