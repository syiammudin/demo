...
<div>
        ...
        <div class="col-lg-12  z-index-41">
            <div class="panel panel-default  ">
                <div class="panel-heading no-border clearfix">
                    <h1 class="page-title">NDT Method</h1>
                </div>
                <div class="panel-body">
                    ...
                    <el-table :data="this.filteredList.slice((page-1)*10, 10*page)" style="width: 100%" >
                        <el-table-column prop="ndt_method" label="Aircraft Type" ></el-table-column>
    ...
    <el-dialog title="Form NDT Method " :visible.sync="showForm" >
        <form class="form-horizontal">
            <div class="form-group">
                <label class="col-md-3">NDT Mehtods</label>
                <div class="col-md-9">
                    <input type="text" class="form-control" v-model="input.ndt_method" placeholder="Name of NDT Methods">
                </div>
            </div>
...
export default {
    ...
    data(){
        return {
            data : [], input : {} , showForm : false, url : BASE_URL + 'ndt_method', search: '', page: 1, formImport : false ,
            inputfile : {}
        }
    },
    mounted(){
